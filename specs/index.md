...
All specifications live in this directory. New specs must follow the naming
convention: `<descriptive-identifier>.md` (e.g., `session-naming.md`,
`dashboard-v2.md`). Reviews go in `reviews/`, prefixed with the spec they
reviewed (e.g., `reviews/jira-board-generator-review.md`).

## Specifications

| File | Description |
|------|-------------|
| [computecommander-v1.md](computecommander-v1.md) | ComputeCommander v1.0 technical specification |
...
| File | Description |
|------|-------------|
| [reviews/jira-board-generator-review.md](reviews/jira-board-generator-review.md) | Review report for jira-board-generator spec |
